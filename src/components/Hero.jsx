...
<section className=" fixed top-0 left-0 w-full text-center py-20 px-6 bg-gradient-to-b from-purple-600 to-white text-white">
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
        ...
        <p className="mb-8 text-md font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 className:text-gray-200">Automate your marketing, engage customers, and grow sales effortlessly and drive economic growth.</p>
